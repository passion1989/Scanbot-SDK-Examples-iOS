 ...
 * For each language exists is a training data file. Scanbot SDK ships with no training data files by default.
 ...
 * By default this path resolves to `.../Application Support/LanguageData/tessdata/`.
 */
