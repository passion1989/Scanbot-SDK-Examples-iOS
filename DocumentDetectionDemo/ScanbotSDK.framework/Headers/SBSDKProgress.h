...
extern NSString * const SBSDKProgressKindTextRecognition;

/** The progress describes a document/PDF creation operation. **/
extern NSString * const SBSDKProgressKindCreatePages;

/** The progress describes an image processing operation. **/
extern NSString * const SBSDKProgressKindProcessImage;
///@}
 ...
 */
typedef void (^SBSDKProgessUpdateHandler)(SBSDKProgress* progress);
 ...
 **/
@property (nonatomic, copy) SBSDKProgessUpdateHandler updateHandler;
 ...
 **/
+ (SBSDKProgress *)progressWithTotalUnitCount:(int64_t)unitCount;
