...
@property (nonatomic, readonly) SBSDKPageAnalyzerResult *pageAnalyzerResult;
 ...
 **/
- (void)appendRecognizedText:(NSString *)text;

/**
 Convenience method to append paragraphs to the receivers paragraphs array.
 Can be used to merge results from multiple OCR operations into a single result.
 **/
- (void)appendParagraphs:(NSArray *)paragraphs;

/**
 Convenience method to append textlines to the receivers lines array.
 Can be used to merge results from multiple OCR operations into a single result.
 **/
- (void)appendLines:(NSArray *)lines;

/**
 Convenience method to append words to the receivers words array.
 Can be used to merge results from multiple OCR operations into a single result.
 **/
- (void)appendWords:(NSArray *)words;

/**
 Convenience method to set the page analyzer result.
 Can be used to merge results from multiple OCR operations into a single result.
 **/
- (void)setPageAnalyzerResult:(SBSDKPageAnalyzerResult *)analyzerResult;
