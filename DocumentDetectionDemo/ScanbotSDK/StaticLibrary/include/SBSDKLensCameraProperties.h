...
@property(nonatomic, readonly) NSString *lensMaker;
 ...
 **/
+ (SBSDKLensCameraProperties *)propertiesFromMetadata:(SBSDKImageMetadata *)metadata;
 ...
 **/
- (instancetype)initWithFocalLength:(double)focalLength sensorSize:(CGSize)sensorSize;
