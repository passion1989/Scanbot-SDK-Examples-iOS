 ...
 */
+ (SBSDKImageMetadata *)extractMetadataFromImageData:(NSData *)imageData;
 ...
 */
+ (NSData *)imageDataByInjectingMetadata:(SBSDKImageMetadata*)metadata intoImageData:(NSData *)imageData;
