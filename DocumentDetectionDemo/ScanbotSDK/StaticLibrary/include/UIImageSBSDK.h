 ...
 */
- (id)initFromSampleBuffer:(CMSampleBufferRef)sampleBuffer;
 ...
 */
- (UIImage *)imageWarpedByPolygon:(SBSDKPolygon *)polygon imageScale:(CGFloat)imageScale;
...
- (UIImage *)imageWarpedByPolygon:(SBSDKPolygon *)polygon
             lensCameraProperties:(SBSDKLensCameraProperties *)lensCameraProperties
 ...
 */
- (UIImage *)imageByProcessingWithRotations:(NSInteger)times
 ...
 */
- (NSData *)imageDataByProcessingWithRotations:(NSInteger)times
                                       polygon:(SBSDKPolygon *)polygon
                                        filter:(SBSDKImageFilterType)filter
                                   compression:(CGFloat)compression
                          lensCameraProperties:(SBSDKLensCameraProperties *)lensCameraProperties
 ...
 * @return The JPEG data of the processed image.
 */
- (NSData *)imageDataByApplyingFilter:(SBSDKImageFilterType)filter compression:(CGFloat)compression;
 ...
 */
+ (NSData *)imageDataWithFixedOrientation:(NSData *)imageData;
