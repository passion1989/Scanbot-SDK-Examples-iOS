 ...
 **/
- (SBSDKCreditCardRecognizerResult *)recognizeCreditCardInfoOnImage:(UIImage *)image;
 ...
 * @return A SBSDKCreditCardRecognizerResult object containing the field data or nil if detection or recognition failed.
 **/
- (SBSDKCreditCardRecognizerResult *)recognizeCreditCardInfoOnBuffer:(CMSampleBufferRef)sampleBufferRef
